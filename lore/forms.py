...
class LorePostForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            "alt_text",
            "original_author",
            "original_author_about",
        ]
        widgets = {
            "title": forms.TextInput(attrs={"class": "form-input", "placeholder": "e.g., The Tortoise and the Birds"}),
            "category": forms.Select(attrs={"class": "form-select"}),
            "excerpt": forms.Textarea(
                attrs={"class": "form-textarea", "rows": 3, "placeholder": "A brief summary of this lore..."}
            ),
            "image_url": forms.URLInput(
                attrs={"class": "form-input", "placeholder": "Optional: URL to stream image from"}
            ),
            "video_url": forms.URLInput(
                attrs={"class": "form-input", "placeholder": "Optional: URL to stream video from (YouTube, Vimeo, etc)"}
            ),
            "audio_url": forms.URLInput(
                attrs={"class": "form-input", "placeholder": "Optional: URL to stream audio from"}
            ),
            ...
            "alt_text": forms.TextInput(
                attrs={"class": "form-input", "placeholder": "Accessibility text for the image"}
            ),
            "original_author": forms.TextInput(
                attrs={"class": "form-input", "placeholder": "Optional: Traditional source or writer"}
            ),
        }
