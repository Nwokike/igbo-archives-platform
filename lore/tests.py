...
class LoreViewTests(TestCase):
    def setUp(self):
        ...
        self.post = LorePost.objects.create(
            title="Igbo Origins", author=self.user, category=self.category, is_approved=True, is_published=True
        )
    ...
    def test_lore_list_sorting(self):
        LorePost.objects.create(
            title="Aardvark Story", author=self.user, category=self.category, is_approved=True, is_published=True
        )
    ...
    def test_lore_detail_has_prev_next_context(self):
        ...
        second_post = LorePost.objects.create(
            title="Second Post", author=self.user, category=self.category, is_approved=True, is_published=True
        )
    ...
    def test_lore_delete_view(self):
        ...
        unapproved_post = LorePost.objects.create(
            title="Deletable Post", author=self.user, is_approved=False, is_published=False
        )
