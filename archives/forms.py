...
class ArchiveForm(forms.ModelForm):
    ...
    date_created = forms.DateField(
        required=False, widget=forms.DateInput(attrs={"type": "date", "class": "form-input"})
    )
    ...
    class Meta:
        ...
        widgets = {
            ...
            "item_count": forms.Select(
                attrs={"class": "form-select", "id": "id_item_count"},
                choices=[
                    (1, "1 item"),
                    (2, "2 items"),
                    (3, "3 items"),
            ...
            "copyright_holder": forms.TextInput(
                attrs={"class": "form-input", "placeholder": "e.g., British Museum, Public Domain"}
            ),
            "original_author": forms.TextInput(
                attrs={"class": "form-input", "placeholder": "e.g., Northcote Thomas", "list": "author-list"}
            ),
            "original_url": forms.URLInput(
                attrs={"class": "form-input", "placeholder": "https://museum.org/collection/item123"}
            ),
            "original_identity_number": forms.TextInput(
                attrs={"class": "form-input", "placeholder": "e.g., BM-1234, NT.001"}
            ),
            "location": forms.TextInput(attrs={"class": "form-input", "placeholder": "e.g., Onitsha, Anambra State"}),
            "circa_date": forms.TextInput(
                attrs={"class": "form-input", "placeholder": "e.g., c1910, around 1910s", "list": "date-list"}
            ),
        }
    ...
    def clean_original_identity_number(self):
        ...
        if existing:
            raise ValidationError(f'An archive with ID Number "{idno}" already exists.')
    ...
    class Meta:
        ...
        widgets = {
            ...
            "document": forms.FileInput(
                attrs={"class": "form-input item-file-input", "accept": ".pdf,.doc,.docx,.txt"}
            ),
...
class AuthorDescriptionRequestForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "proposed_description": forms.Textarea(
                attrs={
                    "class": "form-textarea",
                    "rows": 4,
            ...
            "proposed_image": forms.FileInput(attrs={"class": "form-input", "accept": "image/*"}),
        }
