...
class CategoryModelTests(TestCase):
    ...
    def test_create_category(self):
        ...
        category = Category.objects.create(
            name="Historical Photos", slug="historical-photos", description="Photos from pre-colonial era"
        )
...
class ArchiveModelTests(TestCase):
    ...
    def test_archive_default_is_approved(self):
        ...
        archive = Archive.objects.create(
            title="Test Archive", description="Description", archive_type="image", uploaded_by=self.user
        )
    ...
    def test_archive_get_primary_file_for_image(self):
        ...
        archive = Archive.objects.create(
            title="Image Archive", description="Description", archive_type="image", uploaded_by=self.user
        )
    ...
    def test_archive_has_featured_image(self):
        ...
        archive = Archive.objects.create(
            title="Test Archive", description="Description", archive_type="document", uploaded_by=self.user
        )
    ...
    def test_archive_ordering(self):
        ...
        archive1 = Archive.objects.create(
            title="First", description="First archive", archive_type="image", uploaded_by=self.user
        )
        archive2 = Archive.objects.create(
            title="Second", description="Second archive", archive_type="image", uploaded_by=self.user
        )
...
class ArchiveItemModelTests(TestCase):
    ...
    def setUp(self):
        ...
        self.archive = Archive.objects.create(
            title="Parent Archive", description="Description", archive_type="image", uploaded_by=self.user
        )
    ...
    def test_create_archive_item(self):
        ...
        item = ArchiveItem.objects.create(
            archive=self.archive, item_type="image", caption="Test Caption", item_number=1, image="test.jpg"
        )
...
class ArchiveNoteTests(TestCase):
    ...
    def test_add_note_requires_login(self):
        ...
        response = self.client.post(
            reverse("archives:add_note", kwargs={"slug": self.archive.slug}),
