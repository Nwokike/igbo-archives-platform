...
class ArchiveMediaBrowserTests(TestCase):
    ...
    def test_search_by_title(self):
        ...
        results = Archive.objects.filter(is_approved=True, title__icontains="Mask")
    ...
    def test_filter_by_archive_type(self):
        ...
        video_archive = Archive.objects.create(
            title="Video Archive", description="A video", archive_type="video", uploaded_by=self.user, is_approved=True
        )
    ...
    def test_filter_by_category(self):
        ...
        test_cat_archives = Archive.objects.filter(is_approved=True, category=self.category)
...
class ArchiveQueryTests(TestCase):
    ...
    def test_complex_filter(self):
        ...
        results = Archive.objects.filter(is_approved=True, category=self.category1, archive_type="image")
    ...
    def test_search_across_fields(self):
        ...
        results = Archive.objects.filter(
            Q(title__icontains="Igbo") | Q(description__icontains="Igbo"), is_approved=True
        )
    ...
    def test_ordering(self):
        ...
        archive1 = Archive.objects.create(
            title="First", description="First", archive_type="image", uploaded_by=self.user, is_approved=True
        )
        archive2 = Archive.objects.create(
            title="Second", description="Second", archive_type="image", uploaded_by=self.user, is_approved=True
        )
