...
from users.models import Message, Notification, Thread
...
class CustomUserModelTests(TestCase):
    ...
    def test_user_str_with_full_name(self):
        ...
        user = User.objects.create_user(
            username="testuser", email="test@example.com", password="testpass123", full_name="Test User Full Name"
        )
    ...
    def test_get_display_name_with_full_name(self):
        ...
        user = User.objects.create_user(
            username="testuser", email="test@example.com", password="testpass123", full_name="Display Name"
        )
    ...
    def test_get_display_name_fallback_to_email(self):
        ...
        user = User.objects.create_user(username="testuser", email="john.doe@example.com", password="testpass123")
    ...
    def test_user_can_have_bio(self):
        """Test user bio field."""
        user = User.objects.create_user(
            username="testuser", email="test@example.com", password="testpass123", bio="This is my bio"
        )
...
class NotificationModelTests(TestCase):
    ...
    def test_create_notification(self):
        ...
        notification = Notification.objects.create(recipient=self.user, sender=self.sender, verb="liked your archive")
    ...
    def test_notification_mark_as_read(self):
        ...
        notification = Notification.objects.create(
            recipient=self.user, sender=self.sender, verb="commented on your post"
        )
    ...
    def test_notification_str(self):
        ...
        notification = Notification.objects.create(recipient=self.user, verb="test verb")
...
class ThreadAndMessageTests(TestCase):
    ...
    def test_create_message(self):
        ...
        message = Message.objects.create(thread=thread, sender=self.user1, content="Hello, this is a test message")
