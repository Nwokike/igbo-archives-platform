...
class SocialMediaPoster:
    ...
    def post_to_facebook(self, message, link=None):
        ...
        try:
            ...
            payload = {"message": message, "access_token": self.fb_token}
            if link:
                payload["link"] = link
            ...
            logger.error(
                f"Failed to post to Facebook: {e} - Response: {getattr(e, 'response', '') and getattr(e.response, 'text', '')}"
            )
            return False
    ...
    def post_to_instagram(self, image_url, caption):
        ...
        try:
            ...
            container_payload = {"image_url": image_url, "caption": caption, "access_token": self.fb_token}
            ...
            publish_payload = {"creation_id": container_id, "access_token": self.fb_token}
