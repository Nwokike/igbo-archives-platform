...
class TTSService:
    ...
    def _yarngpt_generate(self, text: str, voice: str) -> dict:
        ...
        try:
            ...
            payload = {"text": text, "voice": voice, "response_format": "mp3"}

            # Increased timeout to 60s as YarnGPT can be slow on large texts
            response = requests.post(self.YARNGPT_API_URL, headers=headers, json=payload, timeout=60)
            ...
            return {"success": False, "audio_bytes": None, "content_type": "", "provider": "yarngpt", "error": str(e)}
